    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            ...
            <div style={{height: '60vh'}}
                ...
                <h1 className="Title text-3xl lg:text-4xl"><a href="https://smartschoolapplicatie-doc.vercel.app/">Smartschool Application</a></h1>
            </div>
            ...
            <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-1 lg:text-left gap-8">
                ...
                <div className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
                    ...
                    <p>Visit the documentation website of the <a style={{color:'blue', textDecoration:'underline'}} href="https://smartschoolapplicatie-doc.vercel.app/">Smartschool
                        Application</a></p>
                </div>
            </div>
        </main>
